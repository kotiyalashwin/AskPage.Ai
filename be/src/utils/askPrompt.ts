export const getAskPrompt = (
  ...
  Suggestion = ${suggestion}. Strictly stick to the context if Suggestion is false and do not give your suggestion. Only give the answer related the context provided. 
